package com.caiths.dengtai.auth.service;

import lombok.RequiredArgsConstructor;
import com.caiths.dengtai.auth.api.dto.AuthResponse;
import com.caiths.dengtai.auth.api.dto.AuthUserResponse;
import com.caiths.dengtai.auth.api.dto.LoginRequest;
import com.caiths.dengtai.auth.api.dto.PasswordResetRequest;
import com.caiths.dengtai.auth.api.dto.RegisterRequest;
import com.caiths.dengtai.auth.api.dto.SendCodeRequest;
import com.caiths.dengtai.auth.api.dto.SendCodeResponse;
import com.caiths.dengtai.auth.api.dto.TokenRefreshRequest;
import com.caiths.dengtai.auth.api.dto.TokenResponse;
import com.caiths.dengtai.auth.audit.LoginLogService;
import com.caiths.dengtai.auth.config.AuthProperties;
import com.caiths.dengtai.common.exception.BusinessException;
import com.caiths.dengtai.common.exception.ErrorCode;
import com.caiths.dengtai.auth.model.ClientInfo;
import com.caiths.dengtai.auth.model.IdentifierType;
import com.caiths.dengtai.auth.token.JwtService;
import com.caiths.dengtai.auth.token.RefreshTokenStore;
import com.caiths.dengtai.auth.token.TokenPair;
import com.caiths.dengtai.user.domain.User;
import com.caiths.dengtai.user.service.UserService;
import com.caiths.dengtai.auth.util.IdentifierValidator;
import com.caiths.dengtai.auth.verification.SendCodeResult;
import com.caiths.dengtai.auth.verification.VerificationCheckResult;
import com.caiths.dengtai.auth.verification.VerificationCodeStatus;
import com.caiths.dengtai.auth.verification.VerificationScene;
import com.caiths.dengtai.auth.verification.VerificationService;
