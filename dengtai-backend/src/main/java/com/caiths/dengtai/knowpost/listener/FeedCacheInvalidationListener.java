package com.caiths.dengtai.knowpost.listener;

import com.fasterxml.jackson.core.type.TypeReference;
import com.caiths.dengtai.counter.event.CounterEvent;
...
public class FeedCacheInvalidationListener {
    ...
    private final com.caiths.dengtai.knowpost.mapper.KnowPostMapper knowPostMapper;

    public FeedCacheInvalidationListener(@Qualifier("feedPublicCache") Cache<String, FeedPageResponse> feedPublicCache,
                                         StringRedisTemplate redis,
                                         ObjectMapper objectMapper,
                                         com.caiths.dengtai.counter.service.UserCounterService userCounterService,
                                         com.caiths.dengtai.knowpost.mapper.KnowPostMapper knowPostMapper) {
